...
checkwin <- function(){
  wld <- list(c(1,2,3),c(4,5,6),c(7,8,9),c(1,4,7),
...
#two functions cpucheckh() and cpucheckc() for cpu to read the board, compare values, 
#ck represents a board with numbers which add up to 15 [8,3,4,1,5,9,6,7,2] represents 
